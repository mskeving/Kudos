...
from settings_helper import (
    Settings, AwsCredentials, S3ImageStore, Database, RealGoogleAuthHandler, MailSender,
    base_dir,
    )
...
settings = Settings(
    ...
    database=database,
    google_auth_handler=RealGoogleAuthHandler('google client id', 'google client secret'),
