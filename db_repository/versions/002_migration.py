...
def upgrade(migrate_engine):
    ...
    post_meta.tables['posts'].columns['photo_url_fullsize'].create()
    post_meta.tables['posts'].columns['status'].create()
...
def downgrade(migrate_engine):
    ...
    post_meta.tables['posts'].columns['photo_url_fullsize'].drop()
    post_meta.tables['posts'].columns['status'].drop()
